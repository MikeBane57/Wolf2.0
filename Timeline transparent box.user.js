...
(function() {
    ...
    function getBoxBackground() {
        return rgbaFromHex(
            resolvePresetColor(getStringPref('timelineBoxFillColor', 'blue'), '#64b5f6'),
    ...
    function getBoxBorder() {
        ...
        return width + 'px solid ' + rgbaFromHex(
            resolvePresetColor(getStringPref('timelineBoxBorderColor', 'blue'), '#64b5f6'),
