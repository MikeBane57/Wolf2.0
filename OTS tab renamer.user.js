...
// @grant        none
// @donkeycode-pref {"otsTabTitleTemplate":{"type":"string","group":"Tab title","label":"Title template","description":"{n} = this tab’s instance number (1, 2, 3…). {base} = the page title before renaming.","default":"OTS {n} · {base}","placeholder":"OTS {n} · {base}"},"otsTabFavicon":{"type":"string","group":"Tab icon","label":"Tab icon (emoji or URL)","description":"Emoji or https://… image URL. Empty = keep site icon.","default":"","placeholder":"📊"}}
