...
(function() {
    ...
    function ensureStyles() {
        ...
        var css = [
            ...
            'padding:7px 10px;',
            '}',
            '#' + PANEL_ID + ' .dc-fims-tc-row--1:hover{',
            'background:linear-gradient(90deg,rgba(255,215,0,.25),rgba(255,215,0,.08));',
            'border-color:rgba(255,215,0,.35);',
            'box-shadow:none;',
            '}',
            '#' + PANEL_ID + ' .dc-fims-tc-row--2:hover{',
            'background:linear-gradient(90deg,rgba(192,192,192,.2),rgba(192,192,192,.06));',
            'border-color:rgba(200,200,210,.3);',
            'box-shadow:none;',
            '}',
            '#' + PANEL_ID + ' .dc-fims-tc-row--3:hover{',
            'background:linear-gradient(90deg,rgba(205,127,50,.22),rgba(205,127,50,.07));',
            'border-color:rgba(205,127,50,.35);',
            'box-shadow:none;',
            '}',
            '#' + PANEL_ID + ' .dc-fims-tc-row:not(.dc-fims-tc-row--1):not(.dc-fims-tc-row--2):not(.dc-fims-tc-row--3):hover{',
            'background:rgba(255,255,255,.06);',
            'border-color:rgba(255,255,255,.08);',
            'box-shadow:none;',
            '}',
            '#' + PANEL_ID + ' .dc-fims-tc-name:hover,',
            '#' + PANEL_ID + ' .dc-fims-tc-count:hover,',
            '#' + PANEL_ID + ' .dc-fims-tc-rank:hover{',
            'color:inherit;',
            'opacity:1;',
