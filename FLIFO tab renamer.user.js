...
(function() {
    ...
    var FAVICON_MIRROR_KEY = 'donkeycode.mirror.flifoTabFavicon';
    ...
    function getFaviconPref() {
        var raw = typeof donkeycodeGetPref === 'function' ? donkeycodeGetPref('flifoTabFavicon') : '';
