...
// @namespace    Wolf 2.0
// @version      1.8.8
// @description  Tight row: detect new highlight class + 2-class outbound rows. Worksheet list: /widgets/worksheet only. Multi-tab: pick by title. Inline send nudged right.
