        ...
        if (getPref('paxLateToWsOpenPaxWindow', true) && clickFd) {
            ...
            if (paxUrl) {
                try {
                    ...
                    window.open(paxUrl, '_blank', 'noopener,noreferrer');
                } catch (e2) {}
            }
        }
